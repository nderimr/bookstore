  ...
  <div class="form-group row">
	...
	<div class="form-group row">
  	...
  	<div class="form-group row">
    	...
    	<div class="col-sm-4">
      		<input type="checkbox" class="form-control" id="bestseller" placeholder="bestseller">
    	</div>
  	</div>
 	...
 	<div class="form-group row">
 		...
 		<div class="col-sm-4">
      		<input type="button" value="Add new" onclick = "createBook()"  class="form-control" id="bestseller" >
    	</div>
 	</div>
</form>
<div class="notes">
...
<script type="text/javascript" src="{{ URL::asset('js/custom/create.js') }}"></script>
